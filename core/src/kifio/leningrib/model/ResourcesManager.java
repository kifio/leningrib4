...
public class ResourcesManager {
    ...
    public static void loadGameAssets(ResourceLoadingListener listener) {
        new LoadingThread(listener).start();
    }
    ...
    private static class LoadingThread extends Thread {
        ...
        private ResourceLoadingListener listener;

        private LoadingThread(ResourceLoadingListener listener) {
        ...
        private void putTrees(Texture treesMap) {
